...
def create_network_animation(params: SimulationParams,
                             ...
                             strategy_update_func: Callable,   # <--- ADD THIS
                             model_name: str,
    ...
    for t in range(params.num_timesteps + 1):
        ...
        if t < params.num_timesteps:
            ...
            # Strategy (Behavioral) Update
            strategy_update_func(state, params)
...
if __name__ == "__main__":
    ...
    create_network_animation(
        ...
        conditional_cooperation_update,         
        "ER + Extreme Popularity + Strategy_update",
        output_file="ER_coevolution.mp4",
        fps=30,
        log_every=5
    )
    ...
    #     extreme_popularity_update,
    #     imitate_payoff_update,
    #     "Cooperator Clique + Extreme Popularity + Strategy_Update",
    #     output_file="CClique_coevolution.mp4",
    #     fps=30,
    #     log_every=5
    # )
    ...
    #     extreme_popularity_update,
    #     imitate_payoff_update,
    #     "BA + Extreme Popularity + Strategy_Update",
    #     output_file="BA_coevolution.mp4",
    #     fps=30,
    #     log_every=5
    # )